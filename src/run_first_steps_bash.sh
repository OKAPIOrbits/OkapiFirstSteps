...
wget --content-on-error --output-document=request_response.json --body-file=pass_prediction_request.json --header="Content-Type: application/json" --header="Accept: application/json" --header="access_token: ${ACCESS_TOKEN_VALUE}"  --method=POST http://okapi.ddns.net:34569/predict-passes/sgp4/requests
...
wget --content-on-error --output-document=pass_prediction_result.json --header="access_token: ${ACCESS_TOKEN_VALUE}" http://okapi.ddns.net:34569/predict-passes/sgp4/summary/results/${request_id}
