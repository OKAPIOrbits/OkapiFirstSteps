...
wget --content-on-error --output-document=pass_prediction_result.json --header="access_token: ${ACCESS_TOKEN_VALUE}" --header="Authorization: Bearer ${ACCESS_TOKEN_VALUE}" https://platform.okapiorbits.com/api/predict-passes/sgp4/results/${request_id}/summary
