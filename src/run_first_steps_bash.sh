...
wget --content-on-error --output-document=pass_prediction_result.json --header="access_token: ${ACCESS_TOKEN_VALUE}" --header="Authorization: Bearer ${ACCESS_TOKEN_VALUE}" http://okapi.ddns.net:34568/predict-passes/sgp4/summary/results/${request_id}
